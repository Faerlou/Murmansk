...
var ASM_CONSTS = {
  4207568: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4207623: function($0) {performance.now = function() { return $0; };},  
 4207671: function($0) {performance.now = function() { return $0; };},  
 4207719: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4207774: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4207835: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4207899: function() {return Module.webglContextAttributes.powerPreference;}
};
...
function zappar_issue_js_plugin_upload_gl_event(){ window.zappar_native_callbacks.upload_gl(); }
  ...
  {
  	var socket = {
  		socket: new WebSocket(Pointer_stringify(url)),
  		error: null,
  		messages: []
  	}
  ...
  function _SocketSend(socketInstance, ptr)
  {
  	var socket = webSocketInstances[socketInstance];
